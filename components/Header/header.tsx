                    ...
                    <div className="flex w-full items-center justify-between px-4 relative z-40">
                        ...
                        <div className="flex items-center justify-end">
                            <div className="mobileNav">
                                <a
                                    href="signup.html"
                                    className="signUpBtn rounded-full nav-shadow btn-gradient px-6 py-2 text-base font-semibold text-white mr-3 duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark"
                                >
                                    Work With Us!
                                </a>
                            </div>
